...
void UserGroupChat::HandleClientGroupNormalRequest(const ChatSessionPtr& pPdu, const ChatSessionPtr& pFromConn)
{
...
void UserGroupChat::HandleGroupNormalResponse(const ChatSessionPtr& pPdu)
{
...
void UserGroupChat::HandleClientGroupInfoRequest(CImPdu *pPdu, const ChatSessionPtr& pFromConn)
{
...
void UserGroupChat::HandleGroupInfoResponse(const ChatSessionPtr& pPdu)
{
...
void UserGroupChat::HandleGroupMessage(const ChatSessionPtr& pPdu)
{
...
void UserGroupChat::HandleGroupMessageBroadcast(CImPdu *pPdu)
{
	IM::Message::IMMsgData msg;
	CHECK_PB_PARSE_MSG(msg.ParseFromArray(pPdu->GetBodyData(), pPdu->GetBodyLength()));
...
void UserGroupChat::HandleClientGroupCreateRequest(const ChatSessionPtr& pPdu, const ChatSessionPtr& pFromConn)
{
...
void UserGroupChat::HandleGroupCreateResponse(const ChatSessionPtr& pPdu)
{
...
void UserGroupChat::HandleClientGroupChangeMemberRequest(const ChatSessionPtr& pPdu, const ChatSessionPtr& pFromConn)
{
...
void UserGroupChat::HandleGroupChangeMemberResponse(const ChatSessionPtr& pPdu)
{
...
void UserGroupChat::HandleGroupChangeMemberBroadcast(const ChatSessionPtr& pPdu)
{
...
void UserGroupChat::HandleClientGroupShieldGroupRequest(CImPdu *pPdu, CMsgConn *pFromConn)
{
...
void UserGroupChat::HandleGroupShieldGroupResponse(CImPdu *pPdu)
{
...
void UserGroupChat::HandleGroupGetShieldByGroupResponse(CImPdu *pPdu)
{
...
void UserGroupChat::_SendPduToUser(const ChatSessionPtr& pPdu, uint32_t user_id, const ChatSessionPtr& pReqConn)
{
	if (!pPdu) {
		return;
	}
