...
void DBServerClient::onConnection(const TcpConnectionPtr& conn)
{
	if (conn->connected())
	{
...
void DBServerClient::onClose(const TcpConnectionPtr& conn)
{
	LOGD("connection: %s is down", conn->peerAddress().c_str());
}

void DBServerClient::onWriteComplete(const TcpConnectionPtr& conn)
{
	LOGD("connection: %s is writecomplete", conn->peerAddress().c_str());
}

void DBServerClient::onHeartBeat()
{
	sendHeartBeat();
}

void DBServerClient::onMessage(const TcpConnectionPtr& conn, Buffer* pBuffer, Timestamp receiveTime)
{
	IMPduPtr pIMPdu;
...
void DBServerClient::handleCommand(const IMPduPtr& pPdu)
{
	if (nullptr == pPdu.get())
		return;
...
void DBServerClient::_HandleValidateResponse(const IMPduPtr& pPdu)
{
...
void DBServerClient::_HandleRecentSessionResponse(const IMPduPtr& pPdu)
{
...
void DBServerClient::_HandleAllUserResponse(const IMPduPtr& pPdu)
{
...
void DBServerClient::_HandleGetMsgListResponse(const IMPduPtr& pPdu)
{
...
void DBServerClient::_HandleGetMsgByIdResponse(const IMPduPtr& pPdu)
{
...
void DBServerClient::_HandleMsgData(const IMPduPtr& pPdu)
{
...
void DBServerClient::_HandleGetLatestMsgIDRsp(const IMPduPtr& pPdu)
{
...
void DBServerClient::_HandleUnreadMsgCountResponse(const IMPduPtr& pPdu)
{
...
void DBServerClient::_HandleUsersInfoResponse(const IMPduPtr& pPdu)
{
...
void DBServerClient::_HandleStopReceivePacket(const IMPduPtr& pPdu)
{
...
void DBServerClient::_HandleRemoveSessionResponse(const IMPduPtr& pPdu)
{
...
void DBServerClient::_HandleChangeAvatarResponse(const IMPduPtr& pPdu)
{
...
void DBServerClient::_HandleDepartmentResponse(const IMPduPtr& pPdu)
{
...
void DBServerClient::_HandleSetDeviceTokenResponse(const IMPduPtr& pPdu)
{
...
void DBServerClient::_HandleGetDeviceTokenResponse(const IMPduPtr& pPdu)
{
...
void DBServerClient::_HandleChangeSignInfoResponse(const IMPduPtr& pPdu) {
...
void DBServerClient::_HandlePushShieldResponse(const IMPduPtr& pPdu) {
...
void DBServerClient::_HandleQueryPushShieldResponse(const IMPduPtr& pPdu) {
