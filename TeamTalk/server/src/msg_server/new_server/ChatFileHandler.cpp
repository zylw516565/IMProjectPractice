...
void ChatFileHandler::HandleClientFileRequest(const ChatSessionPtr& pMsgConn, const IMPduPtr& pPdu)
{
...
void ChatFileHandler::HandleClientFileHasOfflineReq(const ChatSessionPtr& pMsgConn, const IMPduPtr& pPdu)
{
...
void ChatFileHandler::HandleClientFileAddOfflineReq(const ChatSessionPtr& pMsgConn, const IMPduPtr& pPdu)
{
...
void ChatFileHandler::HandleClientFileDelOfflineReq(const ChatSessionPtr& pMsgConn, const IMPduPtr& pPdu)
{
...
void ChatFileHandler::HandleFileHasOfflineRes(const IMPduPtr& pPdu)
{
	IM::File::IMFileHasOfflineRsp msg;
	CHECK_PB_PARSE_MSG(msg.ParseFromArray(pPdu->GetBodyData(), pPdu->GetBodyLength()));
...
void ChatFileHandler::HandleFileNotify(const IMPduPtr& pPdu)
{
